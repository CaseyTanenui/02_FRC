...
# Gets expenses, returns a list which has the costs and expenses..
...
varible_costs_heading = "-------- Variable Costs -------"
...
total_costs_heading = "---- Total and Sales Advice ----"
...
to_write = [product_heading, varible_costs_heading, variable_frame, variable_sub, fixed_costs_heading, fixed_frame, fixed_sub, 
total_costs_heading, all_costs, profit_target, selling_price, recommended_price
]
